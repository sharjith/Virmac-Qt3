 ...
 */
class VirmacDoc : public QObject
{
    Q_OBJECT

	friend class VirmacView;
    ...
    void addView(VirmacView *view);
    /** removes a view from the list of currently connected views */
    void removeView(VirmacView *view);
    /** gets called if a view is removed or added */
    void changedViewList();
    /** returns the first view instance */
    VirmacView* firstView(){ return pViewList->first(); };
     ...
     */
    bool canCloseFrame(VirmacView* pFrame);
    ...
    void ShowSelectedBloc(CNCBlock& bloc);
	 ...
	 */
	void updateAllViews(VirmacView *sender);
    ...
    QList<VirmacView> *pViewList;


    public:
    QString blocString;
    CGLDisplayContext* dContext;
    CMillCutter* myCutter;
    CToolPath* myPath;
    CToolTrail* myTrail;
    CListIteratorOfListOfNCBlock myPathIter;

    CListOfNCBlock* myBlocPointList;
    CListIteratorOfListOfNCBlock myBPListIter;
    CListOfNCBlock* mySelePointList;
    CListIteratorOfListOfNCBlock mySPListIter;

    CStLObject* myStLObj;

    CListOfCTriangle* myTriangleList; // cutter
    CListOfCTriFacet* myFacetList; // model
