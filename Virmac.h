...
class MyWorkspace : public QWorkspace
{
    Q_OBJECT;
    public:
    MyWorkspace( QWidget * parent = 0, const char * name = 0 );
 ...
 */
class VirmacApp : public QMainWindow
{
	...
	*/
	...
	QWorkspace* getWorkspace() { return pWorkspace; }
	...
	QHBox* hb;
	QLabel *cViewer;
	QToolBar *mesgWinFrame;
	QToolBar *promWinFrame;
	QListBox *mesgBox;
	QListBox *promBox;
	 ...
	 * be connected to.
	 */
	void createClient(VirmacDoc* doc);
	...
	//message and prompt bars
	void slotViewMesgBar(bool toggle);
	void slotViewPromBar(bool toggle);
	...
	QPopupMenu *pSimulMenu;
	QPopupMenu *pAnalysisMenu;
	QPopupMenu *pPrefMenu;
	QPopupMenu *pToolMenu;
	QPopupMenu *pTrailMenu;
	QPopupMenu *pModelMenu;
	QPopupMenu *pColorMenu;
	QPopupMenu *pGridMenu;    
	QPopupMenu *pUtilMenu;
