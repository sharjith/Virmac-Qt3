...
class CToolPath : public CGLObject  

{
    public:
	CToolPath();
	CToolPath(const QString& fName);
	CToolPath(const CToolPath& P);
	virtual ~CToolPath();
	...
	CToolPath operator = (const CToolPath& P);
	...
	virtual bool AddBlock(CNCBlock aBlock);
